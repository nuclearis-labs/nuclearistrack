...
import iov from "../img/iov_mono.png"
import rsk from "../img/rsk_mono.png"
import rif from "../img/rif_mono.png"
import {
  FooterBg,
  FooterWrap,
  FooterLeft,
    ...
    <FooterBg>
      <FooterWrap>
        ...
        <FooterRight>
          ...
          <div>
            <a href="https://www.iovlabs.org/" target="_blank" rel="noopener noreferrer"><img src={iov} alt="iov" height="30px" style={{ paddingRight: "15px" }} /></a>
            <a href="https://www.rsk.co/" target="_blank" rel="noopener noreferrer"><img src={rsk} alt="rsk" height="30px" style={{ paddingRight: "15px" }} /></a>
            <a href="https://www.rifos.org/" target="_blank" rel="noopener noreferrer"><img src={rif} alt="rif" height="30px" style={{ paddingRight: "15px" }} /></a>
            <a href="https://github.com/NRS-Soft/nuclearistrack" target="_blank" rel="noopener noreferrer" style={{ paddingRight: "15px" }}>
              <svg
                style={{ marginTop: "3px", }}

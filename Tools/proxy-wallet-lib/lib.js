...
var printUsage = function() {
  ...
  w('-h\t\t\t\t\t\t\t\t Print this help message\n');
	...
	w('--frombtcpk -- [btc-privateKey]\t\t\t\t\t Generate a new RSK address from a Bitcoin Private Key \n')
	w('--to-sbtc -- [btc-address] [btc-privateKey] [btc-amount]\t Send the given amount to the SBTC address corresponding to the BTC address given \n');
...
var OPERATIONS = {
	...
	'to-sbtc': toSbtc,
	'to-btc': toBtc,
	'frombtcpk': generateRSKAddressFromBTCPrivateKey
};

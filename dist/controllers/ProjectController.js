...
exports.getDocNumber = getDocNumber;
function get(req, res) {
    return __awaiter(this, void 0, void 0, function* () {
        try {
            ...
            const allProjectsDetails = allProjects.map((id) => __awaiter(this, void 0, void 0, function* () {
...
function assignProcess(req, res) {
    return __awaiter(this, void 0, void 0, function* () {
        try {
            const { address, privateKey } = yield utils.getKeys(req.body);
            const contract = new Contract_1.default({ privateKey });
...
exports.assignProcess = assignProcess;

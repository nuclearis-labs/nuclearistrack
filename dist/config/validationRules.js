module.exports = {
    ...
    userConfirm: {
        'body.passphrase': 'required|ascii|length:50,4|same:body.confirm_passphrase',
        'params.id': 'required|ascii|length:50,3|savedRecord:User'
    },
    userRestore: {
        'body.mnemonic': 'required|isValidMnemonic',
        'body.newPassphrase': 'required|ascii|length:50,8|same:body.confirm_passphrase'
    },
    userChange: {
        'body.passphrase': 'required|ascii|length:50,3',
        'body.email': 'required|email',
        'body.newPassphrase': 'required|ascii|length:50,4|same:body.confirm_newPassphrase'
    },
    userVerifyAddress: {

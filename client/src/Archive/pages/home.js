...
import { WebTop, WidthContent, BottomSpace, ItemTit, ItemDesc } from '../components/webComponents.js';
...
const TitHome = styled.div`
  ...
  &::after {
    ...
    width: 100%;
    height: 60px; 
    background-image: linear-gradient(to bottom, rgba(26,26,26, .6) 0%, rgba(26, 26, 26, 1) 90%);
    z-index: 2;
  }
  @media (max-width: 580px) {
      font-size:40px;
...
const Heptagram = styled.img`
    ...
    &.hept6{animation-delay: .2s;}
    &.hept5{animation-delay: .4s;}
    &.hept4{animation-delay: .6s;}
    &.hept3{animation-delay: .8s;}
    &.hept2{animation-delay: 1s;}
    &.hept1{animation-delay: 1.2s;}
    @media (max-width: 767px) {left:50%;}
    @media (max-width: 580px) {margin-left: -200px;}
`;
      ...
      <WebBottomHome>
        <WidthContentHome>
          <ColHome>
            ...
            <ItemDescHome>
              SISTEMA ENCRIPTADO CON TECNOLOGIA  BLOCKCHAIN, EL NUEVO ESTANDARD DE SEGURIDAD INFORMATICA.
              <a href="#">CONOCER +</a>
            </ItemDescHome>
          </ColHome>
          <ColHome>

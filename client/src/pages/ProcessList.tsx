      ...
      <FormWrap>
        <Form>
          <HeadRow>
            <Col4>NOMBRE</Col4>
            <Col4>PROVEEDOR</Col4>
            {props.user && props.user.roles.includes("documents:read") && (
              <Col4>VER DOC.</Col4>
            )}
            {props.user && props.user.roles.includes("document:create") && (
          ...
          {data &&
            ...
            data.map((process: IProcess) => (
              <Row key={process.processContracts}>
                ...
                <Col4>
                  {props.user &&
                    props.user.roles.includes("document:create") &&
                    props.user.address === process.supplierAddress && (

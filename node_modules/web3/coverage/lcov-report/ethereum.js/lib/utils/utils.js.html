...
<html lang="en">
<head>
    <title>Code coverage report for ethereum.js/lib/utils/utils.js</title>
    <meta charset="utf-8">
...
<div class="header high">
    <h1>Code coverage report for <span class="entity">ethereum.js/lib/utils/utils.js</span></h1>
    <h2>
        Statements: <span class="metric">100% <small>(109 / 109)</small></span> &nbsp;&nbsp;&nbsp;&nbsp;
        Branches: <span class="metric">90.48% <small>(57 / 63)</small></span> &nbsp;&nbsp;&nbsp;&nbsp;
        Functions: <span class="metric">100% <small>(25 / 25)</small></span> &nbsp;&nbsp;&nbsp;&nbsp;
        Lines: <span class="metric">100% <small>(109 / 109)</small></span> &nbsp;&nbsp;&nbsp;&nbsp;
        Ignored: <span class="metric"><span class="ignore-none">none</span></span> &nbsp;&nbsp;&nbsp;&nbsp;
    </h2>
    <div class="path"><a href="../../../index.html">All files</a> &#187; <a href="index.html">ethereum.js/lib/utils/</a> &#187; utils.js</div>
</div>
<div class="body">
...
473
474
475</td><td class="line-coverage"><span class="cline-any cline-neutral">&nbsp;</span>
...
<span class="cline-any cline-neutral">&nbsp;</span>
<span class="cline-any cline-yes">1</span>
<span class="cline-any cline-yes">676</span>
<span class="cline-any cline-neutral">&nbsp;</span>
<span class="cline-any cline-neutral">&nbsp;</span>
<span class="cline-any cline-neutral">&nbsp;</span>
<span class="cline-any cline-neutral">&nbsp;</span>
...
var padLeft = function (string, chars, sign) {
    return new Array(chars - string.length + 1).join(sign ? <span class="branch-0 cbranch-no" title="branch not covered" >sign </span>: "0") + string;
};
&nbsp;
...
var findIndex = function (array, callback) {
    ...
    return end ? i - 1 : <span class="branch-1 cbranch-no" title="branch not covered" >-1;</span>
};
&nbsp;
/** 
...
var toHexNative = function(str) {
    ...
    for(var i = 0; i &lt; str.length; i++) {
        ...
        hex += n.length &lt; 2 ? <span class="branch-0 cbranch-no" title="branch not covered" >'0' + n </span>: n;
    }
&nbsp;
    return hex;
};
...
var getValueOfUnit = function (unit) {
    unit = unit ? unit.toLowerCase() : <span class="branch-1 cbranch-no" title="branch not covered" >'ether';</span>
...
&nbsp;
    return isBigNumber(number) ? <span class="branch-0 cbranch-no" title="branch not covered" >returnValue </span>: returnValue.toString(10); 
};
&nbsp;
/**
